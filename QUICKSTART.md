...
Review all segment-pair errors, dependencies, priorities, targets, and the candidate payload.
...
```bash
edgeconnect-auto --dotenv .env address-groups deploy --csv address_groups.csv --dry-run
edgeconnect-auto --dotenv .env service-groups deploy --csv service_groups.csv --dry-run
edgeconnect-auto --dotenv .env app-definitions deploy --csv application_definitions.csv --dry-run
edgeconnect-auto --dotenv .env app-groups deploy --csv application_groups.csv --dry-run
edgeconnect-auto --dotenv .env appexpress deploy --csv appexpress_monitor.csv --dry-run
```
